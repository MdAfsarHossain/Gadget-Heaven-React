    ...
    <section className="py-6">
      <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
        ...
        <div className="flex flex-row flex-wrap justify-center mt-20">
          {/* Card - 1 */}
          <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-100 text-gray-800 shadow-2xl border-t-2 hover:scale-105 transition-all">
            <img
              alt=""
              className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full bg-gray-500 shadow-xl"
              src="https://avatars.githubusercontent.com/u/70382472?s=400&u=a11b9681d20a08aad29c65ec89049e9b6bf29668&v=4"
            />
          ...
          <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-100 text-gray-800 shadow-2xl border-t-2 hover:scale-105 transition-all">
            <img
              alt=""
              className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full bg-gray-500"
              src="https://avatars.githubusercontent.com/u/155403563?v=4"
            />
            <div className="flex-1 my-4">
              <p className="text-xl font-semibold leading-snug">Nazim Uddin</p>
              <p>UX Designer</p>
            </div>
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
              <Link
